...
func main() {
	resultPart1 := getResultFromRaces([]Race{{time: 56, distance: 499}, {time: 97, distance: 2210}, {time: 77, distance: 1097}, {time: 93, distance: 1440}})
	resultPart2 := getResultFromRaces([]Race{{time: 56977793, distance: 499221010971440}})
